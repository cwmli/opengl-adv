...
std::string Shader::GetShaderSrc(const GLchar* filePath)
{
...
GLuint Shader::CreateShader(GLenum ShaderType, const GLchar* filePath)
{
...
void Shader::Use() { glUseProgram(this->theProgram); }